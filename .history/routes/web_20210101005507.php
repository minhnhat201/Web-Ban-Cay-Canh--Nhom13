...
//    Route::get('ajax-load-slide','HomeController@loadSlideHome')->name('ajax_get.slide');
    ...
    Route::get('khuyen-mai-hot','PromotionController@index')->name('get.product.promotion'); // sp khuyen mai
    Route::get('san-pham-ban-chay','ProductSellingController@index')->name('get.product.selling'); // sp khuyen mai
    ...
    Route::prefix('shopping')->group(function () {
        ...
        Route::post('thanh-toan-palpay','PaypalShoppingController@postPay')->name('post.shopping.paypal'); // xử lý giỏ hàng lưu thông tin
    });
    ...
    Route::get('he-thong-cua-hang.html','ShopSystemController@index')->name('get.static.shop_system');
});
