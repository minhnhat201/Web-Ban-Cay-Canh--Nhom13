...
class ProductSellingController extends FrontendController
{
    public function index(Request $request)
    {
        ...
        $products = $products->select('id', 'pro_name', 'pro_slug', 'pro_unit','pro_sale', 'pro_number', 'pro_avatar', 'pro_price', 'pro_review_total', 'pro_review_star')
            ->paginate(12);
