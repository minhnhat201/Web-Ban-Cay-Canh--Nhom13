...
@section('content')
    ...
    <section class="content-header">
        <h1>{{  __('admin_article.menu.title_index')}}</h1>
        <ol class="breadcrumb">
        ...
        <div class="box">
            <div class="box-header with-border">
                <div class="box-header">
                    <h3 class="box-title"><a href="{{ route('admin.menu.create') }}" class="btn btn-primary">{{  __('admin_article.menu.btn_add')}} <i class="fa fa-plus"></i></a></h3>
               </div>
                <div class="box-body">
                   <div class="col-md-12">
                        <table class="table">
