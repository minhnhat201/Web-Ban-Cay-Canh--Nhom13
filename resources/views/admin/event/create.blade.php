                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="box-body block-images">
                                <div style="margin-bottom: 10px"> <img src="{{ image_default() }}" onerror="this.onerror=null;this.src='{{  image_default() }}';" alt="" class="img-thumbnail" style="width: 100%;height: 250px;"> </div>
