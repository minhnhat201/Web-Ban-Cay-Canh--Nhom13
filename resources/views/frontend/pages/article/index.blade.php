...
@section('css')
    <?php $style = file_get_contents('css/blog.min.css');echo $style;?>
@stop
<style type="text/css">
    .pagination {
        margin: 10px auto;
                        ...
                        <div class="hot-left">
                            <div class="avatar">
                                <a href="{{ route('get.blog.detail',$articleTop->a_slug.'-'.$articleTop->id) }}" title="" class="image cover">
                                    <img class="lazyload" alt="" src="{{ image_default() }}"  data-src="{{ pare_url_file($articleTop->a_avatar) }}">
                                ...
                                <div class="top">
                                    <div class="avatar">
                                        <a href="{{ route('get.blog.detail',$item->a_slug.'-'.$item->id) }}" title="" class="image cover">
                                            <img class="lazyload" alt="" src="{{ image_default() }}" data-src="{{ pare_url_file($item->a_avatar) }}">
                                        </a>
                                    </div>
