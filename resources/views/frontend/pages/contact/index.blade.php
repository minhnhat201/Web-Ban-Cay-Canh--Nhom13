...
@section('css')
    <?php $style = file_get_contents('css/static.min.css');echo $style;?>
@stop
@section('content')
    <div class="container">
        <div class="breadcrumb">
            <ul>
                ...
                <li itemscope="" >
                    <a itemprop="url" href="#" title="Đồng hồ chính hãng"><span itemprop="title">Contact</span></a>
                </li>
            </ul>
        </div>
        <div class="auth" style="background: white;">
            <form class="from_cart_register" action="" method="post" style="width: 500px;margin:0 auto;padding: 30px 0">
                ...
                <div class="form-group">
                    <label for="phone">Content <span class="cRed">(*)</span></label>
